define('tariff-selector', ['jquery', 'moment', 'commonUI'], 
       function($, moment, commonUI) {
  ...
  function readUiConfig() {
    ...
    console.log('chooseProductMultipleRateTypes', _settings ? _settings.chooseProductMultipleRateTypes : null);
    return {
      showRates: true, //commonSettings.chooseProductMultipleRateTypes,
  ...
  return {
    ...
    setCommonSettings: function(settings) {
      _settings = settings;
    },
